        ...
        <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">
                    ...
                    <li><a class="color_animation" href="${createLink(controller:'user', action:'editProfile')}">EDIT PROFILE </a></li>
...
<div class="main">
    ...
    <div class="content page1"><div class="ic"></div>
        <div class="container_12">
            ...
            <div class="grid_12">
                <div class="car_wrap">
                    <h2>Here are the Restaurant You may like</h2>
                    <div class="clear"></div>

                    <ul >


                        <g:each in="${recommendedrestaurant}" var ="restaurants">
                            <li>
                                <div id="${restaurants["id"]}" class="page1_block col1">
                                    %{--<img src="${assetPath(src: 'welcome_img.png')}">--}%
                                    <img src="${resource(dir:'images',file:restaurants["photo"][0])} " width="191" height="179" />

                                    <div class="extra_wrapper">
                                        <div class="col1 upp"> <a href="#"><h3>${restaurants["name"][0]}</h3></a></div>
                                        <br/>
                                        <p> ${restaurants["description"][0]}</p>
                                        <p> ${restaurants["location"][0]}</p>
                                        <p> ${restaurants["contactno"][0]}</p>
